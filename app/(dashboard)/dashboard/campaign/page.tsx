  ...
  return (
    <div className="space-y-2">
      <Card className="bg-accent px-4 py-6">
        <CardTitle>
          Send your first outbound Email campaign
        </CardTitle>
        ...
        <Card key={campaignItem.campaignId}> 
          <CardContent className="flex items-center justify-between space-x-4 p-4 gap-4">
            ...
            <Switch 
              ...
              onCheckedChange={() => campaignItem.campaignId !== undefined && toggleCampaignEnabled(campaignItem.campaignId)}
            />
            ...
            <div className="flex">
              <p className="text-xs text-muted-foreground w-14">
                {new Date(campaignItem.createdAt).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', hour12: true })}
              </p>
                ...
                <PopoverContent>
                  <div className="grid gap-4">
                    <Button asChild variant={"outline"}>
                      <Link href={"/dashboard/campaign/123"}>Edit Campaign</Link>
                    </Button>
                  </div>
                </PopoverContent>
              </Popover>
