...
export function Mail({
  ...
  <TabsTrigger value="all" className="text-zinc-800 dark:text-zinc-200 hidden sm:block">
    To approve
  </TabsTrigger>
  ...
  <DropdownMenu.Root>
    <DropdownMenu.Trigger asChild>
      <TabsTrigger
        value="more"
        className="text-zinc-800 dark:text-zinc-200 flex items-center space-x-1 sm:hidden"
      >
        <svg
          className="h-6 w-6"
          viewBox="0 0 24 24"
    ...
    <DropdownMenu.Portal className="right-3">
      <DropdownMenu.Content className="text-sm absolute right-0 z-10 mt-2 w-38 origin-top-right rounded-md bg-zinc-200 shadow-lg dark:bg-zinc-800" align="center">
      <DropdownMenu.Item className=" block cursor-pointer px-3 py-2 align-middle text-zinc-800 dark:text-zinc-200 hover:bg-zinc-300 dark:hover:bg-zinc-700 hover:rounded-md transition-colors duration-200 ease-in-out">
