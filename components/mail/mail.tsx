      ...
      >
        ...
        >
          <ScrollArea className="h-full">
            {filteredMails.length > 0 && filteredMails ? (
              <ThreadDisplayMain ownerEmail={filteredMails[0].recipient} />
            ) : (
              <p className="flex justify-center items-center mt-10 text-gray-500">
                No Draft Available
              </p>
...
// }: MailProps) {
//   const [mails, setMails] = React.useState<Conversations[]>([]);
//   const [activeMail, setActiveMail] = React.useState<Conversations | null>(
//     null
//   ); // Active mail state
//   const [loading, setLoading] = React.useState(true);
//   const [error, setError] = React.useState<string | null>(null);
...
//   React.useEffect(() => {
//     if (filteredMails.length > 0) {
//       setActiveMail(filteredMails[0]); // Set active mail to the first filtered mail
//       setSenderEmail(filteredMails[0].sender);
//       setRecipientEmail(filteredMails[0].recipient); // Set recipient email for ThreadDisplayMain
//       setConversationId(filteredMails[0].id); // Set conversation ID for ThreadDisplayMain
//     } else {
//       setActiveMail(null); // Clear active mail if no filtered mails
//       setSenderEmail("");
//       setRecipientEmail("");
//       setConversationId("");
//     }
...
//   console.log("Mail Convo ID", conversationId);
...
//           <ScrollArea className="h-full">
//             {activeMail ? (
//               <ThreadDisplayMain ownerEmail={activeMail.recipient} />
//             ) : (
//               <p className="flex justify-center items-center mt-10 text-gray-500">
//                 No Draft Available
//               </p>
