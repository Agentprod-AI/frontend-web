...
import { PeopleProfileSheet } from "@/components/people-profile-sheet";
import { Lead } from "@/context/lead-user";
// import { useFieldValues } from "@/context/training-field-value";
interface PreviewContentProps {
  email: {
    subject: string;
    body: string;
        ...
        <div className="flex justify-center p-6">
          <div className="flex-col w-full">
            ...
            <div className="flex mt-2 items-center">
              ...
              <Input
                ...
                value={
                  newPreviews
                    ? newSubject
                    : initialEmail.subject || autoGeneratedSubject
                }
                readOnly
              />
            </div>
            <div className="flex flex-row gap-2 mt-3">
              <TextField
                text={
                  newPreviews ? newBody : initialEmail.body || autoGeneratedBody
                }
              />
            </div>
          </div>
