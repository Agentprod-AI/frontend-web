    ...
    const fetchData = async () => {
      try {
        if (previewType === "previewFromAI") {
          ...
          const responseFollowUp2 = await axios.post(
            "https://agentprod-backend-framework-zahq.onrender.com/v2/training/autogenerate/followup",
            {
              user_id: user.id,
              follow_up_number: 2,
              previous_emails: [
                ...
                { subject: response.data.subject, body: response.data.body },
              ],
            }
          );
          setAutoGeneratedFollowUpTwo(
            `${responseFollowUp2.data.subject}\n\n${responseFollowUp2.data.body}`
          );
          setLoad2(false);
        } else {
          alert("normal");
        ...
        <div className="flex justify-center p-6">
          <div className="flex-col w-full">
            ...
            <div className="flex flex-col gap-2 mt-3">
              ...
              <Textarea
                className="h-[200px]"
                value={autoGeneratedFollowUp ? autoGeneratedFollowUp : ""}
                readOnly
              />
            </div>
            <div className="flex flex-col gap-2 mt-3">
              ...
              <Textarea
                className="h-[200px]"
                value={autoGeneratedFollowUpTwo ? autoGeneratedFollowUpTwo : ""}
                readOnly
              />
            </div>
          </div>
